...
Токтарова В. И. Технология JavaServer Pages: учебное пособие / Мар. гос. ун-т; В. И. Токтарова – Йошкар-Ола, 2012. – 104 с.
        </div>
       
		   <div class="images" align="center">
          <a href="material/JSP toktarova.doc"><img src="img/3.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/JSP toktarova.doc">Учебное пособие (doc, 2782 КБ)</a></center>
            </div>
    ...
    <div class="left_body_main">
 Сервлеты и JSP: методические указания для выполнения лабораторных работ / Мар. гос. ун-т; сост. В.И. Токтарова. – Йошкар-Ола, 2010. – 43 с.
 </div>
    <br>        
			<div class="images" align="center"><br><br>
          <a href="material/Сервлеты и JSP.doc"><img src="img/4.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 0px;" href="material/Сервлеты и JSP.doc">Методические указания для выполнения лабораторных работ (doc, 907 КБ)</a></center>
            </div>
             
            </div>    
        <div class="left_body_main">
  <br>      
Карабцев С.Н. ПРОГРАММИРОВАНИЕ НА JAVA: лабораторный практикум / Кем. гос. ун-т - Кемерово, 2012.  
        </div>
       
		   <div class="images" align="center">
          <a href="material/ПРОГРАММИРОВАНИЕ НА JAVA.pdf"><img style="width: 620px;" src="img/1.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/ПРОГРАММИРОВАНИЕ НА JAVA.pdf">Лабораторный практикум (pdf, 1124 КБ)</a></center>
            </div>
             
            </div>
        <br>
<div class="left_body_main">
Программирование на языке Java [Электронный ресурс]. Режим доступа: http://www.novsu.ru/file/937832/ свободный.

 </div>
			<div class="images" align="center">
          <a href="material/Java. Лабораторные работы 2012.doc"><img style="width: 620px;" src="img/2.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/Java. Лабораторные работы 2012.doc">Здания на лабораторные работы (doc, 142 КБ)</a></center>
      ...
      <div class="event_wrap">
        ...
        <div class="event_meddile_wrap">
          <div class="feb_wrap">
		   ...
		   <p class="green_righte"><a href="#">Дополнительные информационно-справочные материалы</a><br />
