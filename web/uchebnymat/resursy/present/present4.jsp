...
<h2 class="h2">Классы и интерфейсы</h2>
        </div>
       
		   <div class="images">
          <a href="material/Лекция 3_2.pdf"><img style="width: 620px;" src="img/4.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/Лекция 3_2.pptx">Презентация (pptx, 380 КБ)</a></center>
            </div>
      ...
      <div class="event_wrap">
        ...
        <div class="event_meddile_wrap">
          <div class="feb_wrap">
		   ...
		   <br><br>
		   <span class="busniess_area_text1"><a href="#" class="read_more2">Классы и интерфейсы </a></span>
