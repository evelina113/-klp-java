...
<h2 class="h2">Объектно-ориентированные принципы Java</h2>
		   ...
		   <div class="images">
          <a href="material/Лекция 3_1.pdf"><img style="width: 620px;" src="img/3.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/Лекция 3_1.pptx">Презентация (pptx, 277 КБ)</a></center>
            </div>
      ...
      <div class="event_wrap">
        ...
        <div class="event_meddile_wrap">
		  ...
		  <span class="busniess_area_text1"><a href="present1.jsp" class="read_more2">Введение в Java</a></span>
		   ...
		   <br>
		   <span class="busniess_area_text1"><a href="#" class="read_more2">Объектно-ориентированные принципы Java</a></span>
		   <br><br>
