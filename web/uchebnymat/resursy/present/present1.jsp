...
<h2 class="h2">Введение в Java</h2>
        </div>
       
		   <div class="images">
          <a href="material/Лекция 1.pdf"><img style="width: 620px;" src="img/1.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/Лекция 1.pptx">Презентация (pptx, 1781 КБ)</a></center>
            </div>
      ...
      <div class="event_wrap">
        ...
        <div class="event_meddile_wrap">
          <div class="feb_wrap">
		   ...
		   <span class="busniess_area_text1"><a href="#" class="read_more2">Введение в Java</a></span>
