...
<h2 class="h2">Основы программирования на языке Java</h2>
        </div>
       
		   <div class="images">
          <a href="material/Лекция 2.pdf"><img style="width: 620px;" src="img/2.png"></a> <br />
            <div id="left">
              <center><a style="padding-left: 40px;" href="material/Лекция 2.pptx">Презентация (pptx, 989 КБ)</a></center>
            </div>
      ...
      <div class="event_wrap">
        ...
        <div class="event_meddile_wrap">
          <div class="feb_wrap">
		   ...
		   <span class="busniess_area_text1"><a href="#" class="read_more2">Основы программирования на языке Java </a></span>
		   <br>
		   ...
		   <span class="busniess_area_text1"><a href="present7.jsp" class="read_more2">GUI программирование. Swing</a></span><br>
