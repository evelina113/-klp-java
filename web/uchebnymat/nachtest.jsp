...
0
7
примитивный тип данных определяется языком программирования как базовая встроенная единица языка
ссылочные переменные не могут принимать значение null
ссылочные типы данных включают в себя целочисленные (integer), дробные (floating-point) и булевы (boolean)
...
<!-- nom vopr -->
<!-- vopros
Выберите группу, относящуюся к примитивным типам данных:
vopros end -->
...
набор констант иабстрактных методов
нет верного ответа
...
<br>
    ...
    <div id="winotv">
<form action="nachtest.jsp"  method="post"> <!--menyaesh nasootv test!-->
...
<input type="submit" name="butSave" id="butSave" class="buttonss2" value="Сохранить результат">
  ...
  {
  String q1,q2,q3,q4,q5,q6,q7,q8,q9,mar,riA;
  int idU, idT;
  ...
  idT=0; idT=12; //nomer testa ne zabud mat tvoyu
  try
  {
...
sql="insert into otv (test_ID, user_ID, question_1, question_2, question_3, question_4,"
        + " question_5, question_6, question_7, question_8, question_9, right_answers, mark"
...
'<input type=radio name=Q1><span name="aspan" class="aspan" onclick="getchecked(1,0)"> примитивный тип данных определяется языком программирования как базовая встроенная единица языка</span><br>'
...
+'<input type=radio name=Q1><span name="aspan" class="aspan" onclick="getchecked(1,2)"> ссылочные типы данных включают в себя целочисленные (integer), дробные (floating-point) и булевы (boolean)</span><br>'
...
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,2)"> набор констант иабстрактных методов</span><br>'
