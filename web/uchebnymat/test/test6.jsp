...
var time1= new Date();
var rez=[3,8,4,1,4,8,4,8,1,8];
var temas=['- Обработка событий. Пакеты для обработки событий.','- Обработка событий. Источники событий.','- События. Типы слушателей.','- Обработка событий. Пакет java.awt.event.','- Обработка событий. События.','- Обработка событий. Классы-адаптеры.','- Обработка событий. События и типы слушателей.','- Обработка событий. Удаление слушателя.','- Обработка событий. Делегирование событий.','- Обработка событий. Связь между источником событий, слушателем и интерфейсами.'];
...
<h2 class="h2">Тест №6. Обработка событий</h2>
</div>
...
<!-- vopros
Какие пакеты используются для обработки событий в Java:
vopros end -->
...
<!-- nom vopr -->
<!-- vopros
Выберите верную общую форму методов для регистрации одного или нескольких слушателей:
vopros end -->
...
0
6
public void<ТипСобытия>Listener (TypeListener e) {…}
public void add<ТипСобытия>Listener (TypeListener e) {…}
public void add<ТипСобытия>Source (TypeListener e) {…}
public add<ТипСобытия>Listener (TypeListener e) {…}
...
<!-- nom vopr -->
<!-- vopros
Метод, позволяющий узнать в каком объекте произошло событие?
vopros end -->
...
public Object setEvent()
public Object setSource()
...
Объект, описывающий изменение состояния источника события
Объект класса, который реализует специальный интерфейс
Класс, расширяющий суперкласс Event
...
<!-- nom vopr -->
<!-- vopros
Выберите верные утверждения относительно класса адаптера? 
vopros end -->
...
0
7
Класс предлагает пустую реализацию всех методов интерфейса слушателя событий
Класс определен внутри другого класса или даже внутри выражения
Класс адаптер содержит только один метод события
Классы-адаптеры удобны для интерфейсов, имеющих один метод
...
<!-- nom vopr -->
<!-- vopros
Слушатель событий - это объект класса, который реализует специальный интерфейс -…
vopros end -->
...
<!-- nom vopr -->
<!-- vopros
Какой метод используется для удаления слушателя, который не отвечает на события?
vopros end -->
...
0
7
rеmоveТипСлушателя(типСлушателя е)
rеmоveТипСобытия(типСобытия е)
rеmоveТипИсточника(типИсточника е)
нет верного ответа
...
<!-- nom vopr -->
<!-- vopros
Основа модели делегирования событий:
vopros end -->
...
0
4
источник извещает о слушателях одно или несколько событий
слушатель извещает об источнике одно или несколько событий
слушатель извещает о событии один или несколько источников
источник событий генерирует события и посылает их одному или нескольким слушателям
...
<!-- nom vopr -->
<!-- vopros
Для чего нужны слушатели событий?
vopros end -->
...
0
7
Они "слушают", что происходит в объекте, чтобы отследить возникновение события и обработать его
Они "слушают", что происходит в объекте, чтобы связаться с обработчиком события
Они "слушают", что происходит в объекте, чтобы задать обработку события
Нет верного ответа
...
<br>
    ...
    <div id="winotv">
<form action="test6.jsp"  method="post"> <!--menyaesh nasootv test!-->
...
<input type="submit" name="butSave" id="butSave" class="buttons" value="Сохранить результат">
  ...
  idT=0; idT=6; //nomer testa ne zabud mat tvoyu
  try
  {
...
'\<!-- otvet--\>\r\n'+
'<input type=checkbox name=Q1 class="niceCheck"><span name="aspan" class="aspan" onclick="getchecked(1,0)"> javax.awt.event</span><br>'
+'<input type=checkbox name=Q1 class="niceCheck"><span name="aspan" class="aspan" onclick="getchecked(1,1)"> java.swing.event</span><br>'
+'<input type=checkbox name=Q1 class="niceCheck"><span name="aspan" class="aspan" onclick="getchecked(1,2)"> java.awt.event</span><br>'
+'<input type=checkbox name=Q1 class="niceCheck"><span name="aspan" class="aspan" onclick="getchecked(1,3)"> javax.swing.event</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Объект, в котором произошло событие, называется:'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf2"></div>' +
'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,0)"> источником события</span><br>'
+'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,1)"> слушателем</span><br>'
+'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,2)"> интерфейсом слушателя</span><br>'
+'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,3)"> обработчиком события</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Выберите верную общую форму методов для регистрации одного или нескольких слушателей:'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf3"></div>' +
'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,0)"> public void<ТипСобытия>Listener (TypeListener e) {…}</span><br>'
+'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,1)"> public void add<ТипСобытия>Listener (TypeListener e) {…}</span><br>'
+'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,2)"> public void add<ТипСобытия>Source (TypeListener e) {…}</span><br>'
+'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,3)"> public add<ТипСобытия>Listener (TypeListener e) {…}</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Метод, позволяющий узнать в каком объекте произошло событие?'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf4"></div>' +
'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,0)"> public Object getEvent() </span><br>'
+'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,1)"> public Object setEvent()</span><br>'
+'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,2)"> public Object setSource()</span><br>'
+'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,3)"> public Object getSource()</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Что такое событие в Java?'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf5"></div>' +
'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,0)"> Объект, в котором произошло событие</span><br>'
+'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,1)"> Объект, описывающий изменение состояния источника события</span><br>'
+'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,2)"> Объект класса, который реализует специальный интерфейс</span><br>'
+'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,3)"> Класс, расширяющий суперкласс Event</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Выберите верные утверждения относительно класса адаптера? '+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf6"></div>' +
'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,0)"> Класс предлагает пустую реализацию всех методов интерфейса слушателя событий</span><br>'
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,1)"> Класс определен внутри другого класса или даже внутри выражения</span><br>'
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,2)"> Класс адаптер содержит только один метод события</span><br>'
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,3)"> Классы-адаптеры удобны для интерфейсов, имеющих один метод</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Слушатель событий - это объект класса, который реализует специальный интерфейс -…'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf7"></div>' +
'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,0)"> интерфейс события</span><br>'
+'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,1)"> интерфейс слушателя</span><br>'
+'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,2)"> интерфейс источника события</span><br>'
+'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,3)"> нет верного ответа</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Какой метод используется для удаления слушателя, который не отвечает на события?'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf8"></div>' +
'<input type=radio name=Q8><span name="aspan" class="aspan" onclick="getchecked(8,0)"> rеmоveТипСлушателя(типСлушателя е)</span><br>'
+'<input type=radio name=Q8><span name="aspan" class="aspan" onclick="getchecked(8,1)"> rеmоveТипСобытия(типСобытия е)</span><br>'
+'<input type=radio name=Q8><span name="aspan" class="aspan" onclick="getchecked(8,2)"> rеmоveТипИсточника(типИсточника е)</span><br>'
+'<input type=radio name=Q8><span name="aspan" class="aspan" onclick="getchecked(8,3)"> нет верного ответа</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Основа модели делегирования событий:'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf9"></div>' +
'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,0)"> источник извещает о слушателях одно или несколько событий</span><br>'
+'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,1)"> слушатель извещает об источнике одно или несколько событий</span><br>'
+'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,2)"> слушатель извещает о событии один или несколько источников</span><br>'
+'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,3)"> источник событий генерирует события и посылает их одному или нескольким слушателям</span><br>'
,
'<font color="#333333" size="3"><p><b>\r\n'+
'Для чего нужны слушатели событий?'+
'</b></p></font><font color="#333333" size="3"><div class="otv" id="torf10"></div>' +
'<input type=radio name=Q10><span name="aspan" class="aspan" onclick="getchecked(10,0)"> Они "слушают", что происходит в объекте, чтобы отследить возникновение события и обработать его</span><br>'
+'<input type=radio name=Q10><span name="aspan" class="aspan" onclick="getchecked(10,1)"> Они "слушают", что происходит в объекте, чтобы связаться с обработчиком события</span><br>'
+'<input type=radio name=Q10><span name="aspan" class="aspan" onclick="getchecked(10,2)"> Они "слушают", что происходит в объекте, чтобы задать обработку события</span><br>'
        ...
        <div class="event_meddile_wrap">
          <div class="feb_wrap">
			...
			<p class="green_right">Обработка событий<br />
              <span class="busniess_area_text1"><a href="#" class="read_more2">Тест №6</a></span></p>
